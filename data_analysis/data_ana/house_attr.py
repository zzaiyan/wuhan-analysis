...
count_other_fwhx = pd.Series({"其他": df['fwhx'].value_counts()[10:-1].count()})
...
ax.set_title("武汉二手房房屋户型占比情况", fontsize=18)
count_fwhx.plot(kind="pie", cmap=plt.cm.rainbow, autopct="%3.1f%%", fontsize=12)
plt.savefig('../data_ana/picture/武汉二手房房屋户型占比情况.svg', format='svg')
...
fig = plt.figure(figsize=(9, 9))
ax = fig.add_subplot(111)
ax.set_title("武汉二手房装修占比情况", fontsize=18)
count_zxqk.plot(kind="pie", cmap=plt.cm.rainbow, autopct="%3.1f%%", fontsize=12)
plt.savefig('../data_ana/picture/武汉二手房装修占比情况.svg', format='svg')
...
fig = plt.figure(figsize=(9, 9))
ax = fig.add_subplot(111)
ax.set_title("武汉二手房建筑类型占比情况", fontsize=18)
count_jzlx.plot(kind="pie", cmap=plt.cm.rainbow, autopct="%3.1f%%", fontsize=12)
plt.savefig('../data_ana/picture/武汉二手房建筑类型占比情况.svg', format='svg')
...
ax = fig.add_subplot(111)
ax.set_title("武汉二手房房源朝向分布情况", fontsize=18)
count_fwcx.plot(kind="bar", fontsize=12)

plt.savefig('../data_ana/picture/武汉二手房房源朝向分布情况.svg', format='svg')
