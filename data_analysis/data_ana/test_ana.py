...
# mean_unitprice = groups_unitprice_area.mean(numeric_only=True)
# mean_unitprice.index.name = "各区域名称"
#
# fig = plt.figure(figsize=(12, 7))
# ax = fig.add_subplot(111)
# ax.set_ylabel("单价(元/平米)")
# ax.set_title("武汉各区域二手房平均单价")
...
ax1.set_title("武汉各区域二手房平均单价")
ax2 = fig.add_subplot(2, 1, 2)
ax2.set_ylabel("建筑面积(㎡)")
ax2.set_title("武汉各区域二手房平均建筑面积")
